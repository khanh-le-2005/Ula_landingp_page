...
const FeatureCard = ({ number, title, subTitle, imgSrc }: { number: string; title: string; subTitle: string; imgSrc: string }) => (
  <div className="bg-white rounded-[24px] sm:rounded-[32px] p-4 sm:p-6 border border-white/60 flex flex-col group transition-all duration-500 shadow-sm">
...
const Methodology = () => {
  ...
  return (
    <section className="p-4 sm:p-6 lg:p-12 font-sans text-slate-800 flex items-center justify-center rounded-xl reveal" id="methodology">
