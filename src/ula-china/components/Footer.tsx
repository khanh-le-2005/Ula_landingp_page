      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="mt-6 rounded-[15px] border border-white/10 bg-white/5 p-4">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col space-y-3">
              <input
                ...
                className="w-full rounded-[15px] border border-white/10 bg-white/5 px-4 py-3 text-sm text-white transition-all placeholder:text-slate-500 focus:border-[#c5a059] focus:bg-white/10 focus:outline-none"
              />
              <Link
                to="/register"
                state={registerRouteState}
                className="inline-flex w-full items-center justify-center rounded-[15px] bg-gradient-to-r from-[#c5a059] to-[#dfc38a] py-3 text-sm font-black uppercase tracking-widest text-[#1a2b48] transition-all hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(197,160,89,0.3)]"
              >
                Đăng ký ngay
              </Link>
            </div>
