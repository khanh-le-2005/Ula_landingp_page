...
export const heroDefault: HeroContent = {
  ...
  headlineTop: 'HỌC TIẾNG TRUNG TỪ SỚM',
  headlineHighlight: 'KHÔNG CẦN GIỎI',
  headlineBottom: 'CHỈ CẦN ĐÚNG CÁCH',
  description:
    'Học tiếng Trung thông minh cùng AI. Chỉ 30p/ngày tại nhà với video bài giảng + AI sửa phát âm + lộ trình rõ từng ngày.',
...
export const painpointsDefault: PainpointsContent = {
  ...
  bubbles: [
    ...
    'Đã sang Trung nhưng không nói được',
    'Tiếng Trung khó',
    'Học xong lại quên',
  ],
};
