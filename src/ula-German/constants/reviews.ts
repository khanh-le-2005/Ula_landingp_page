export const REVIEWS_DATA = [
  ...
  },
  {
    name: "Phạm Gia Huy",
    level: "B2 German",
    avatar: "https://i.pravatar.cc/150?u=huypg",
    text: "Kỹ năng nghe nói của mình cải thiện vượt bậc. AI feedback giúp mình sửa phát âm ngay lập tức.",
    tags: ["Phát âm", "AI Feedback"],
    likes: 156,
  },
  {
    name: "Hoàng Kim Ngân",
...
export const REVIEWS_COLUMN_LEFT = REVIEWS_DATA.slice(0, 3);
export const REVIEWS_COLUMN_RIGHT = REVIEWS_DATA.slice(3, 6);
