...
const Experience = () => {
  ...
  return (
    <section id="experience" className="min-h-screen flex flex-col items-center py-12 px-4 font-sans relative overflow-hidden reveal">
      ...
      <div className="w-full max-w-5xl bg-white/30 backdrop-blur-2xl rounded-[32px] md:rounded-[40px] overflow-hidden min-h-[50px] md:min-h-[600px] flex flex-col relative z-10 reveal">
        ...
        <div className="flex-grow flex flex-col">
          ...
          {activeTab === 'quiz' && (
            <>
              ...
              <div className="px-6 py-8 md:px-10 md:py-10 border-t border-white/60">
                {status === 'idle' && (
                  ...
                  <div className="w-full bg-white/30 border border-green-200 rounded-[2.5rem] p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-sm animate-in fade-in slide-in-from-bottom-2">
                    <div className="flex items-center gap-3 sm:gap-4 text-left ml-2 sm:ml-4">
                      ...
                      <div className="text-left">
                        <h5 className="text-green-800 font-black text-sm sm:text-base">Chính xác!</h5>
                        <p className="text-green-700 font-medium opacity-80 text-xs sm:text-sm">{currentQuiz.explanation || 'Bạn đã nối đúng tất cả các cặp từ!'}</p>
                      </div>
                    </div>
                    <button onClick={handleNext} className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#10b981] hover:bg-green-600 text-white px-6 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-black text-[11px] sm:text-xs uppercase tracking-widest shadow-lg transition-transform hover:scale-105 active:scale-95">
                ...
                {status === 'wrong' && (
                  <div className="w-full bg-white/30 border border-red-200 rounded-[2.5rem] p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-sm animate-in fade-in slide-in-from-bottom-2">
                    <div className="flex items-center gap-3 sm:gap-4 text-left ml-2 sm:ml-4 text-left">
                      <div className="bg-white rounded-full p-1.5 text-red-500 shadow-sm border border-red-100 shrink-0">
                        <XCircle size={20} className="text-red-500" />
                      </div>
                      <div>
                        <h5 className="text-red-800 font-black text-sm sm:text-base">Chưa chính xác</h5>
                        <p className="text-red-700 font-medium opacity-80 text-xs sm:text-sm">Hãy thử lại xem sao nhé.</p>
                      </div>
                    </div>
                    <button onClick={handleRetry} className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#ef4444] hover:bg-red-600 text-white px-6 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-black text-[11px] sm:text-xs uppercase tracking-widest shadow-lg transition-transform hover:scale-105 active:scale-95">
                        ...
                        <div className={`absolute inset-x-4 bottom-2.5 md:inset-x-8 md:bottom-4 z-20 transition-all duration-300 ${showControls ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
                          <div className="mx-auto bg-white/95 rounded-full px-4 py-1.5 md:px-6 md:py-2.5 flex items-center gap-3 md:gap-5 shadow-xl backdrop-blur-sm h-8" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div
                              ...
                              className="relative flex-grow h-1.5 bg-slate-300 rounded-full cursor-pointer group/progress touch-none"
                            >
                              <div
