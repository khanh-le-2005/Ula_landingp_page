    ...
    <section className="py-4 md:py-8 text-white rounded-[2rem] md:rounded-[3rem] bg-white/50 mx-4 md:mx-6 mb-20 md:mb-24 overflow-hidden relative reveal [transform:translateZ(0)]" id="luckywheel">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center relative z-10">
        <div className="space-y-6 md:space-y-8 text-center md:text-left">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-[1.1] text-slate-900 tracking-tight">
            {content.headline}
          </h2>
          {content.subHeadline && (
            <div className="inline-block mt-2 text-4xl sm:text-5xl md:text-6xl font-extrabold bg-clip-text text-[#e0a31d] drop-shadow-[0_6px_16px_rgba(197,160,89,0.14)] [-webkit-text-stroke:0.5px_#ffffcc] drop-shadow-sm filter brightness-110 ">
              {content.subHeadline}
            </div>
          )}
