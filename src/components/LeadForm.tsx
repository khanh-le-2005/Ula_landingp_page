...
const LeadForm: React.FC<ConsultationModalProps> = ({
  ...
  return (
    <div
      id="lead-form"
      className="relative flex items-center justify-center overflow-y-visible py-12 px-3 md:p-5"
    >
      <div
        role="dialog"
        className={`relative z-10 w-full max-w-[1140px] overflow-hidden rounded-[1.65rem] border border-white/85 bg-white/96 p-3 shadow-[0_28px_80px_rgba(148,163,184,0.24)] backdrop-blur-xl md:p-3.5 lg:mr-3 lg:p-4 ${theme.shellGlow}`}
      >
        {step === "form" ? (
