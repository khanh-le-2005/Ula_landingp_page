...
export default function Hero() {
  ...
  return (
    <section
      ref={heroSectionRef}
      className="relative flex min-h-[72svh] items-start bg-cover bg-center overflow-hidden pb-0 md:min-h-[90svh] md:pb-10 lg:min-h-screen"
    // style={{
      ...
      <div className="w-full mx-auto px-4 sm:px-10 lg:px-16 py-4 md:py-10 relative z-10">
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-10 lg:gap-18 items-center">
          <div className="space-y-5 md:space-y-8 animate-in fade-in slide-in-from-left duration-700 text-center lg:text-left mt-2 md:mt-0 order-2 lg:order-1">
            <div className="hidden md:inline-flex items-center justify-center gap-2.5 rounded-full border border-[#ead7a8] bg-[#fff7e8]/90 px-4 py-2 shadow-sm backdrop-blur-sm leading-none">
            ...
            <h1 className="font-be-vietnam text-[27px] sm:text-[32px] lg:text-[54px] font-extrabold text-[#1a2b48] leading-[1.08] tracking-[-0.01em] drop-shadow-xl">
              ...
              <span className="block mt-0 sm:mt-1 pt-1 lg:pt-2">
                ...
                <span className="mt-3 inline-block font-be-vietnam text-[27px] sm:text-[32px] lg:text-[54px] font-extrabold text-[#1a2b48] leading-[1.08] tracking-[-0.01em] drop-shadow-xl">
                  {hero.headlineBottom}
                </span>
              </span>
            </h1>
